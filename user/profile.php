...
if (isset($_POST['update'])) {
    ...
    $stmt = $conn->prepare("UPDATE users SET email=?, contact=?, model=?, company=?, password=? WHERE id=?");
    $stmt->bind_param("sssssi", $email, $contact, $model, $company, $password, $user_id);
...
<div class="card">
    ...
    <form method="POST" action="profile.php">
        ...
        <input type="text" name="model" value="<?php echo $user['model']; ?>">
